...
public class BaseActivity extends AppCompatActivity {
    ...
    protected void initDrawer(Bundle bundle) {
        ...
        headerNavigationLeft = new AccountHeader()
                ...
                .addProfiles(
                        new ProfileDrawerItem().withName("").withIcon(getResources().getDrawable(R.mipmap.ic_launcher))
                )
        ...
        fullView.addItem(new PrimaryDrawerItem().withName("Home").withIcon(getResources().getDrawable(R.mipmap.ic_launcher)));
        fullView.addItem(new PrimaryDrawerItem().withName("Pedidos").withIcon(getResources().getDrawable(R.mipmap.ic_launcher)));
        fullView.addItem(new PrimaryDrawerItem().withName("Clientes").withIcon(getResources().getDrawable(R.mipmap.ic_launcher)));
        fullView.addItem(new PrimaryDrawerItem().withName("Importar Dados").withIcon(getResources().getDrawable(R.mipmap.ic_launcher)));
        fullView.addItem(new PrimaryDrawerItem().withName("Exportar Dados").withIcon(getResources().getDrawable(R.mipmap.ic_launcher)));

        fullView.addItem(new PrimaryDrawerItem().withName("Sair").withIcon(getResources().getDrawable(R.mipmap.ic_launcher)));
