...
import com.br.minasfrango.views.ClientePedidoViewHolder;
import com.br.minasfrango.views.PedidosViewHolder;
        ...
        simButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(!motivoCancelamentoETextView.getText().toString().isEmpty() ){
                    ...
                    PedidoDAO pedidoDAO = PedidoDAO.getInstace(Pedido.class);
