...
public class DriveServiceHelper {
    ...
    public Task<Void> saveFile(String fileId, String name, String content) {
        return Tasks.call(mExecutor, () -> {
            ...
            ByteArrayContent contentStream = ByteArrayContent.fromString("image/*", content);
    ...
    public Task<String> criarPastaNoDrive(String nomeDaPasta)  {
        ...
        return Tasks.call(mExecutor, new Callable<String>() {
            ...
            public String call() throws Exception {
                ...
                if(file!=null){
                   ...
                   inserirArquivoNaPasta( file.getId() ,CameraUtil.LOCAL_ONDE_A_IMAGEM_FOI_SALVA);
